...
image = ImageCaptcha(fonts=[r'E:\Github\python-mini-projects\projects\Captcha_Genrator\fonts\ChelseaMarketsr.ttf', r'E:\Github\python-mini-projects\projects\Captcha_Genrator\fonts\DejaVuSanssr.ttf'])
